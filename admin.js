...
var PART2_Q=["Вам нужно вспомнить, когда умер первый губернатор Мерфи Кальрад, назовите точную дату.", "Какова была заключительная причина смерти губернатора Мерфи Кальрада?", "Какая ферма горела, так сильно, что дым доходил до самого города? Назовите адрес этой фермы.", "Опишите четкий путь от входа Мэрии штата РПМ, до входа в казино. Пример: 30 метров вперед, 10 метров вправо.", "У кого из лидеров штата РПМ SOUTH был первый провальный срок? Назовите его имя и фамилию.", "Отредактируйте объявление которое подали в СМИ: «Продам сумку “RPM money”».", "Человек демонстрировал оружие своему знакомому, вы полицейский, который это заметил. Какую статью вы ему бы инкриминировали?", "Вы врач перед вами человек, который ушиб ногу, опишите свои действия, чтобы ему помочь.", "Кто был первым лидером в баскетбольном клубе “The crips”? Назовите имя и фамилию.", "В какой день был открыт штат rpm SOUTH? Назовите дату его открытия.", "В один из далеких дней, горел бар. Цпд потушили его, но из-за чего они позже очень злились, на одну из фракций? Вспомните, на какую фракцию в тот момент они злились? И какова была причина их злости, понесла ли та фракция наказание после этого?", "Скажите, а какая ваша фракция самая любимая?", "Пожалуйста, дайте оценку ЕГЭ, поделитесь впечатлениями и мнением о вопросах, были ли они легкими или сложными."];

...
var PART2_Q=["Что такое команда /me? Для чего она используется? Приведи 2 примера правильной отыгровки.", "Что такое команда /do? Чем отличается от /me? Приведи пример использования.", "Что такое /try и как работает система удачи? Когда нужно использовать /try?", "Что такое /todo? Как совместить речь и действие? Приведи пример.", "Приведи пример правильной отыгровки ДТП (аварии) через команды /me и /do.", "Приведи пример отыгровки передачи/продажи предмета через /me. Как показать действие?", "Что такое NonRP Drive и NonRP поведение? Приведи 2 примера нарушений.", "Что такое PowerGaming (PG) и FearRP? Объясни на примерах, как их нарушают.", "Что такое MG (Metagaming) и DM? Почему они запрещены на RP сервере?", "Отыграй через /me и /do задержание подозреваемого: от надевания наручников до посадки в авто."];

...
var PART2=[{"q": "Губернатор важнее судьи? Может ли губернатор отменить решение суда? Распишите своё мнение."}, {"q": "Чем отличается приказ губернатора от федерального закона? Что выше по силе?"}, {"q": "Вы стали свидетелем коррупции в Мэрии. Куда обратитесь и как докажете?"}, {"q": "Почему нельзя посещать военную базу без пропуска? Что будет за нарушение?"}, {"q": "Опишите порядок задержания по ЕПК: от остановки до суда."}, {"q": "Может ли сотрудник СМИ снимать задержание? Какие у него права и ограничения?"}, {"q": "В чём разница между IC и OOC? Приведите примеры нарушений."}, {"q": "Что такое RolePlay и почему нельзя использовать MG (Metagaming)?"}, {"q": "Вы — лидер фракции. Как бы вы повысили дисциплину состава? Предложите 3 меры."}, {"q": "Опишите идеальный RolePlay процесс: от создания персонажа до повышения во фракции."}];

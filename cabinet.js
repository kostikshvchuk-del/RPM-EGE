...
var PART2=[{"q": "Что такое команда /me? Для чего она используется? Приведи 2 примера правильной отыгровки."}, {"q": "Что такое команда /do? Чем отличается от /me? Приведи пример использования."}, {"q": "Что такое /try и как работает система удачи? Когда нужно использовать /try?"}, {"q": "Что такое /todo? Как совместить речь и действие? Приведи пример."}, {"q": "Приведи пример правильной отыгровки ДТП (аварии) через команды /me и /do."}, {"q": "Приведи пример отыгровки передачи/продажи предмета через /me. Как показать действие?"}, {"q": "Что такое NonRP Drive и NonRP поведение? Приведи 2 примера нарушений."}, {"q": "Что такое PowerGaming (PG) и FearRP? Объясни на примерах, как их нарушают."}, {"q": "Что такое MG (Metagaming) и DM? Почему они запрещены на RP сервере?"}, {"q": "Отыграй через /me и /do задержание подозреваемого: от надевания наручников до посадки в авто."}];
